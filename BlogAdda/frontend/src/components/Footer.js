...
export const Footer = () => {
  return (
    <footer class="bg-white dark:bg-gray-900 bg-gradient-to-r from-slate-950 via-gray-700 to-slate-950">
      <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
            <Link to="/" class="flex items-center">
              {/* <img src={balogo} class="h-8 mr-3" alt="BlogAdda Logo" /> */}
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              ...
              <ul class="text-gray-500 dark:text-gray-400 font-medium">
                <li class="mb-4">
                  <a
                    href="https://github.com/omchikhaliya/BlogAdda"
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <div class="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
            ...
            <a
              href="#"
              class="text-gray-500 hover:text-gray-900 hover:text-indigo-700"
            >
              <svg
                class="w-4 h-4"
                aria-hidden="true"
